...
class page_output
{
	...
	function render_html()
	{
		...
		else
		{
			...
			print '<p><label><input type="checkbox" id="refresh" onchange="javascript:toggle();" checked/>Refresh automatically</label></p><script>var t;function toggle(){if (document.getElementById("refresh").checked) {t=setTimeout(function(){document.location.reload()}, 5000);}else{clearTimeout(t);}};toggle();</script>';
